...
<img src="docs/menu.png" alt="The BranchBar menu: repositories grouped under Frontend and Backend headers, each row showing its current branch, with repositories on the same branch sharing a color" width="325">
